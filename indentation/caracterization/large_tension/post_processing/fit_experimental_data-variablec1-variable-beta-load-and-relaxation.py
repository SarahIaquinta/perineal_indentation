...
def compute_stress_vector_step_variable_c1_variable_beta_load(parameters, datafile, sheet, step, previous_step_values):
...
def find_parameters_variablec1_variable_beta_load_and_relaxation(datafile, sheet, step, previous_step_values, previous_step_optimized_parameters, minimization_method):
    ...
    def minimization_function(parameters):
        Q_list_load, S_list_load, S_H_list_load, Pi_list_load = compute_stress_vector_step_variable_c1_variable_beta_load(parameters, datafile, sheet, step, previous_step_values)
...
def find_parameters_all_steps_variable_c1_variable_beta(datafile, sheet, minimization_method_load):
    ...
    optimized_c1_step_0, optimized_beta_step_0, optimized_tau_step_0, parameters_step_0 = find_parameters_variablec1_variable_beta_load_and_relaxation(datafile, sheet, 0, previous_step_values, initial_guess_load, minimization_method_load)
    c1_dict_load[0] = optimized_c1_step_0
    beta_dict_load[0] = optimized_beta_step_0
    tau_dict_load[0] = optimized_tau_step_0
    Q_list, S_list, S_H_list, Pi_list = compute_stress_vector_step_variable_c1_variable_beta_load(parameters_step_0,  datafile, sheet, 0, previous_step_values)
    ...
    tau_relaxation = optimized_tau_step_0
    ...
    for p in list(step_numbers)[1:]:
        optimized_c1_load, optimized_beta_load, optimized_tau_load, parameters = find_parameters_variablec1_variable_beta_load_and_relaxation(datafile, sheet, p, previous_step_values, previous_step_optimized_parameters_load, minimization_method_load)
        c1_dict_load[p] = optimized_c1_load
        beta_dict_load[p] = optimized_beta_load
        tau_dict_load[p] = optimized_tau_load
        Q_list, S_list, S_H_list, Pi_list = compute_stress_vector_step_variable_c1_variable_beta_load(parameters,  datafile, sheet, p, previous_step_values)
        ...
        tau_relaxation = optimized_tau_load
...
def plot_results_variable_c1_variable_beta_load_and_relaxation(datafile, sheet, minimization_method_load):
    ...
    def plot_fitted_parameters(datafile, sheet, minimization_method_load):
        ...
        savefigure.save_as_png(fig_c1_vs_step, datafile[0:6] + "_" + sheet + "fitted_params_c1_vs_load_step_L_" + minimization_method_load + "_variablec1_variable_beta_load_and_relaxation")
        savefigure.save_as_png(fig_beta_vs_step, datafile[0:6] + "_" + sheet + "fitted_params_beta_vs_load_step_L_" + minimization_method_load + "_variablec1_variable_beta_load_and_relaxation")
        savefigure.save_as_png(fig_tau_vs_step, datafile[0:6] + "_" + sheet + "fitted_params_tau_vs_load_step_L_" + minimization_method_load + "_variablec1_variable_beta_load_and_relaxation")

        savefigure.save_as_png(fig_c1_vs_elongation, datafile[0:6] + "_" + sheet + "fitted_params_c1_vs_load_elongation_L_" + minimization_method_load + "_variablec1_variable_beta_load_and_relaxation")
        savefigure.save_as_png(fig_beta_vs_elongation, datafile[0:6] + "_" + sheet + "fitted_params_beta_vs_load_elongation_L_" + minimization_method_load + "_variablec1_variable_beta_load_and_relaxation")
        savefigure.save_as_png(fig_tau_vs_elongation, datafile[0:6] + "_" + sheet + "fitted_params_tau_vs_load_elongation_L_" + minimization_method_load + "_variablec1_variable_beta_load_and_relaxation")

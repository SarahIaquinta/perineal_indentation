...
def compute_and_export_indicators_with_maturation_as_pkl(ids_list, date_dict, delta_d_dict, delta_d_star_dict, d_min_dict, A_dict, failed_A_acqusitions):
    ...
    for i in range(len(dates)):
        date = dates[i]
        mean_delta_d_FF1_date, std_delta_d_FF1_date, mean_delta_d_star_FF1_date, std_delta_d_star_FF1_date, mean_d_min_FF1_date, std_d_min_FF1_date,  mean_A_FF1_date, std_A_FF1_date = compute_mean_and_std_at_given_date_and_meatpiece(int(date), 'FF1', ids_list, date_dict, delta_d_dict, delta_d_star_dict, d_min_dict, A_dict, failed_A_acqusitions)
        mean_delta_d_FF2_date, std_delta_d_FF2_date, mean_delta_d_star_FF2_date, std_delta_d_star_FF2_date, mean_d_min_FF2_date, std_d_min_FF2_date,  mean_A_FF2_date, std_A_FF2_date = compute_mean_and_std_at_given_date_and_meatpiece(int(date), 'FF2', ids_list, date_dict, delta_d_dict, delta_d_star_dict, d_min_dict, A_dict, failed_A_acqusitions)
        mean_delta_d_RDG1_date, std_delta_d_RDG1_date, mean_delta_d_star_RDG1_date, std_delta_d_star_RDG1_date, mean_d_min_RDG1_date, std_d_min_RDG1_date,  mean_A_RDG1_date, std_A_RDG1_date = compute_mean_and_std_at_given_date_and_meatpiece(int(date), 'RDG1', ids_list, date_dict, delta_d_dict, delta_d_star_dict, d_min_dict, A_dict, failed_A_acqusitions)
        mean_delta_d_RDG2_date, std_delta_d_RDG2_date, mean_delta_d_star_RDG2_date, std_delta_d_star_RDG2_date, mean_d_min_RDG2_date, std_d_min_RDG2_date,  mean_A_RDG2_date, std_A_RDG2_date = compute_mean_and_std_at_given_date_and_meatpiece(int(date), 'RDG2', ids_list, date_dict, delta_d_dict, delta_d_star_dict, d_min_dict, A_dict, failed_A_acqusitions)
        mean_delta_d_FF_date, std_delta_d_FF_date, mean_delta_d_star_FF_date, std_delta_d_star_FF_date, mean_d_min_FF_date, std_d_min_FF_date,  mean_A_FF_date, std_A_FF_date = compute_mean_and_std_at_given_date_and_meatpiece(int(date), 'FF', ids_list, date_dict, delta_d_dict, delta_d_star_dict, d_min_dict, A_dict, failed_A_acqusitions)
        mean_delta_d_RDG_date, std_delta_d_RDG_date, mean_delta_d_star_RDG_date, std_delta_d_star_RDG_date, mean_d_min_RDG_date, std_d_min_RDG_date,  mean_A_RDG_date, std_A_RDG_date = compute_mean_and_std_at_given_date_and_meatpiece(int(date), 'RDG', ids_list, date_dict, delta_d_dict, delta_d_star_dict, d_min_dict, A_dict, failed_A_acqusitions)
...
def plot_laser_indicators_vs_texturometer_forces():
    ...
    with open(complete_pkl_filename_laser, "rb") as f:
        [dates_laser, mean_delta_d_FF1, std_delta_d_FF1, mean_delta_d_star_FF1, std_delta_d_star_FF1, mean_d_min_FF1, std_d_min_FF1,  mean_A_FF1, std_A_FF1,
             mean_delta_d_FF2, std_delta_d_FF2, mean_delta_d_star_FF2, std_delta_d_star_FF2, mean_d_min_FF2, std_d_min_FF2,  mean_A_FF2, std_A_FF2,
             mean_delta_d_RDG1, std_delta_d_RDG1, mean_delta_d_star_RDG1, std_delta_d_star_RDG1, mean_d_min_RDG1, std_d_min_RDG1,  mean_A_RDG1, std_A_RDG1,
             mean_delta_d_RDG2, std_delta_d_RDG2, mean_delta_d_star_RDG2, std_delta_d_star_RDG2, mean_d_min_RDG2, std_d_min_RDG2,  mean_A_RDG2, std_A_RDG2,
             mean_delta_d_FF, std_delta_d_FF, mean_delta_d_star_FF, std_delta_d_star_FF, mean_d_min_FF, std_d_min_FF,  mean_A_FF, std_A_FF,
    ...
    [dates_laser, mean_delta_d_FF1, std_delta_d_FF1, mean_delta_d_star_FF1, std_delta_d_star_FF1, mean_d_min_FF1, std_d_min_FF1,  mean_A_FF1, std_A_FF1,
             ...
             mean_delta_d_FF, std_delta_d_FF, mean_delta_d_star_FF, std_delta_d_star_FF, mean_d_min_FF, std_d_min_FF,  mean_A_FF, std_A_FF,
             mean_delta_d_RDG, std_delta_d_RDG, mean_delta_d_star_RDG, std_delta_d_star_RDG, mean_d_min_RDG, std_d_min_RDG,  mean_A_RDG, std_A_RDG
             ] = [dates_laser, mean_delta_d_FF1[1:], std_delta_d_FF1[1:], mean_delta_d_star_FF1[1:], std_delta_d_star_FF1[1:], mean_d_min_FF1[1:], std_d_min_FF1[1:],  mean_A_FF1[1:], std_A_FF1[1:],
    ...
    ax_A_vs_force80_1.errorbar(list(mean_force80_FF1_dict.values()), mean_A_FF1, yerr=std_A_FF1, xerr=list(std_force80_FF1_dict.values()) ,lw=0, label='FF1', **kwargs_FF1)
    ax_A_vs_force80_1.errorbar(list(mean_force80_RDG1_dict.values()), mean_A_RDG1, yerr=std_A_RDG1, xerr=list(std_force80_RDG1_dict.values()) ,lw=0, label='RDG1', **kwargs_RDG1)
    ...
    ax_A_vs_force80_2.errorbar(list(mean_force80_FF2_dict.values()), mean_A_FF2, yerr=std_A_FF2, xerr=list(std_force80_FF2_dict.values()) ,lw=0, label='FF2', **kwargs_FF2)
    ax_A_vs_force80_2.errorbar(list(mean_force80_RDG2_dict.values()), mean_A_RDG2, yerr=std_A_RDG2, xerr=list(std_force80_RDG2_dict.values()) ,lw=0, label='RDG2', **kwargs_RDG2)
    ...
    ax_A_vs_force80.errorbar(list(mean_force80_FF_dict.values()), mean_A_FF, yerr=std_A_FF, xerr=list(std_force80_FF_dict.values()) ,lw=0, label='FF', **kwargs_FF)
    ax_A_vs_force80.errorbar(list(mean_force80_RDG_dict.values()), mean_A_RDG, yerr=std_A_RDG, xerr=list(std_force80_RDG_dict.values()) ,lw=0, label='RDG', **kwargs_RDG)
...
if __name__ == "__main__":
    ...
    plot_recovery_indicators_with_maturation() #TODO check plot functions

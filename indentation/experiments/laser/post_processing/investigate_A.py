...
def remove_failed_A_and_small_deltad(deltad_threshold, strain_threshold, filenames_from_pkl, dates_dict, Umax_dict, def_dict, thickness_dict, delta_d_dict, delta_d_star_dict, d_min_dict, A_dict, failed_A_acqusitions):
    """
    Removes the values of A that have not been properly computed or for which the experimental
    testing did not go well
    ...
    ids_where_not_failed_and_not_small_deltad = [id for id in ids_where_not_failed if float(delta_d_dict[id]) > deltad_threshold*float(Umax_dict_not_failed[id]) and float(def_dict[id]) < strain_threshold]
...
def compute_mean_and_std_at_given_date_and_meatpiece(date, meatpiece, deltad_threshold, strain_threshold, ids_list, date_dict, Umax_dict, def_dict, thickness_dict, delta_d_dict, delta_d_star_dict, d_min_dict, A_dict, failed_A_acqusitions):
    """
...
def compute_and_export_indicators_with_maturation_as_pkl(ids_list, date_dict, Umax_dict, def_dict, thickness_dict, delta_d_dict, delta_d_star_dict, d_min_dict, A_dict, failed_A_acqusitions, deltad_threshold, strain_threshold):
    """
    ...
    for i in range(len(dates)):
        date = dates[i]
        mean_Umax_FF1, std_Umax_FF1, mean_def_FF1, std_def_FF1, mean_thickness_FF1, std_thickness_FF1, mean_delta_d_FF1_date, std_delta_d_FF1_date, mean_delta_d_star_FF1_date, std_delta_d_star_FF1_date, mean_d_min_FF1_date, std_d_min_FF1_date,  mean_A_FF1_date, std_A_FF1_date = compute_mean_and_std_at_given_date_and_meatpiece(int(date[0:6]), 'FF1', deltad_threshold,strain_threshold, ids_list, date_dict,  Umax_dict, def_dict, thickness_dict, delta_d_dict, delta_d_star_dict, d_min_dict, A_dict, failed_A_acqusitions)
        mean_Umax_FF2, std_Umax_FF2, mean_def_FF2, std_def_FF2, mean_thickness_FF2, std_thickness_FF2, mean_delta_d_FF2_date, std_delta_d_FF2_date, mean_delta_d_star_FF2_date, std_delta_d_star_FF2_date, mean_d_min_FF2_date, std_d_min_FF2_date,  mean_A_FF2_date, std_A_FF2_date = compute_mean_and_std_at_given_date_and_meatpiece(int(date[0:6]), 'FF2', deltad_threshold,strain_threshold, ids_list, date_dict,  Umax_dict, def_dict, thickness_dict, delta_d_dict, delta_d_star_dict, d_min_dict, A_dict, failed_A_acqusitions)
        mean_Umax_RDG1, std_Umax_RDG1, mean_def_RDG1, std_def_RDG1, mean_thickness_RDG1, std_thickness_RDG1, mean_delta_d_RDG1_date, std_delta_d_RDG1_date, mean_delta_d_star_RDG1_date, std_delta_d_star_RDG1_date, mean_d_min_RDG1_date, std_d_min_RDG1_date,  mean_A_RDG1_date, std_A_RDG1_date = compute_mean_and_std_at_given_date_and_meatpiece(int(date[0:6]), 'RDG1', deltad_threshold,strain_threshold, ids_list, date_dict,  Umax_dict, def_dict, thickness_dict, delta_d_dict, delta_d_star_dict, d_min_dict, A_dict, failed_A_acqusitions)
        mean_Umax_RDG2, std_Umax_RDG2, mean_def_RDG2, std_def_RDG2, mean_thickness_RDG2, std_thickness_RDG2, mean_delta_d_RDG2_date, std_delta_d_RDG2_date, mean_delta_d_star_RDG2_date, std_delta_d_star_RDG2_date, mean_d_min_RDG2_date, std_d_min_RDG2_date,  mean_A_RDG2_date, std_A_RDG2_date = compute_mean_and_std_at_given_date_and_meatpiece(int(date[0:6]), 'RDG2', deltad_threshold,strain_threshold, ids_list, date_dict,  Umax_dict, def_dict, thickness_dict, delta_d_dict, delta_d_star_dict, d_min_dict, A_dict, failed_A_acqusitions)
        mean_Umax_FF, std_Umax_FF, mean_def_FF, std_def_FF, mean_thickness_FF, std_thickness_FF, mean_delta_d_FF_date, std_delta_d_FF_date, mean_delta_d_star_FF_date, std_delta_d_star_FF_date, mean_d_min_FF_date, std_d_min_FF_date,  mean_A_FF_date, std_A_FF_date = compute_mean_and_std_at_given_date_and_meatpiece(int(date[0:6]), 'FF', deltad_threshold,strain_threshold, ids_list, date_dict,  Umax_dict, def_dict, thickness_dict, delta_d_dict, delta_d_star_dict, d_min_dict, A_dict, failed_A_acqusitions)
        mean_Umax_RDG, std_Umax_RDG, mean_def_RDG, std_def_RDG, mean_thickness_RDG, std_thickness_RDG ,mean_delta_d_RDG_date, std_delta_d_RDG_date, mean_delta_d_star_RDG_date, std_delta_d_star_RDG_date, mean_d_min_RDG_date, std_d_min_RDG_date,  mean_A_RDG_date, std_A_RDG_date = compute_mean_and_std_at_given_date_and_meatpiece(int(date[0:6]), 'RDG', deltad_threshold,strain_threshold, ids_list, date_dict,  Umax_dict, def_dict, thickness_dict, delta_d_dict, delta_d_star_dict, d_min_dict, A_dict, failed_A_acqusitions)
...
def export_indocators_as_txt(deltad_threshold, strain_threshold):
    """
    ...
    complete_txt_filename_FF2 = path_to_processed_data + "/0_locations_deltad_threshold" + str(deltad_threshold) + "strain_treshold" + str(strain_threshold) + "_indicators_mean_std_FF2.txt"
    ...
    complete_txt_filename_FF = path_to_processed_data + "/0_locations_deltad_threshold" + str(deltad_threshold) + "strain_treshold" + str(strain_threshold) + "_indicators_mean_std_FF.txt"
    ...
    f.close()
    complete_txt_filename_RDG1 = path_to_processed_data + "/0_locations_deltad_threshold" + str(deltad_threshold) + "strain_treshold" + str(strain_threshold) + "_indicators_mean_std_RDG1.txt"
    ...
    complete_txt_filename_RDG2 = path_to_processed_data + "/0_locations_deltad_threshold" + str(deltad_threshold) + "strain_treshold" + str(strain_threshold) + "_indicators_mean_std_RDG2.txt"
    ...
    complete_txt_filename_RDG = path_to_processed_data + "/0_locations_deltad_threshold" + str(deltad_threshold) + "strain_treshold" + str(strain_threshold) + "_indicators_mean_std_RDG.txt"
    ...
    complete_txt_filename_all = path_to_processed_data + "/0_locations_deltad_threshold" + str(deltad_threshold) + "strain_treshold" + str(strain_threshold) + "_indicators_mean_std.txt"
    ...
    complete_txt_filename_all = path_to_processed_data + "/Umax_mean_std_and_pvalues.txt"
    f = open(complete_txt_filename_all, "w")
    
    f.write("Umax - 1 \n")
    f.write(" date \t  mean Umax FF1 \t  std Umax FF1 \t  mean Umax RDG1 \t  std Umax RDG1 \t  pvalue Umax (FF1 vs RDG1) \n")
    for i in range(len(mean_delta_d_FF1_dict)):
        date = dates_laser[i]
        f.write(
            str(date)
            ...
            + str(std_Umax_RDG1_dict[date])
            + "\t"
            + str(Umax_pvalue_dict_1[int(date[0:6])])
            + "\n"
        )    

    f.write("Umax - 2 \n")
    f.write(" date \t  mean Umax FF2 \t  std Umax FF2 \t  mean Umax RDG2 \t  std Umax RDG2 \t  pvalue Umax (FF2 vs RDG2) \n")
    for i in range(len(mean_delta_d_FF2_dict)):
        date = dates_laser[i]
        f.write(
            str(date)
            ...
            + str(std_Umax_RDG2_dict[date])
            + "\t"
            + str(Umax_pvalue_dict_2[int(date[0:6])])
            + "\n"
        ) 
        
    f.write("Umax - 1+2 \n")
    f.write(" date \t  mean Umax FF \t  std Umax FF \t  mean Umax RDG \t  std Umax RDG \t  pvalue Umax (FF vs RDG) \n")
    for i in range(len(mean_delta_d_FF_dict)):
        date = dates_laser[i]
        f.write(
            str(date)
            ...
            + str(std_Umax_RDG_dict[date])
            + "\t"
            + str(Umax_pvalue_dict_12[int(date[0:6])])
            + "\n"
        )         
    f.close()


    complete_txt_filename_all = path_to_processed_data + "/def_mean_std_and_pvalues.txt"
    f = open(complete_txt_filename_all, "w")
    ...
    complete_txt_filename_all = path_to_processed_data + "/thickness_mean_std_and_pvalues.txt"
    f = open(complete_txt_filename_all, "w")
    
    f.write("thickness - 1 \n")
    f.write(" date \t  mean thickness FF1 \t  std thickness FF1 \t  mean thickness RDG1 \t  std thickness RDG1 \t  pvalue thickness (FF1 vs RDG1) \n")
    for i in range(len(mean_delta_d_FF1_dict)):
        date = dates_laser[i]
        f.write(
            str(date)
            ...
            + str(std_thickness_RDG1_dict[date])
            + "\t"
            + str(thickness_pvalue_dict_1[int(date[0:6])])
            + "\n"
        )    

    f.write("thickness - 2 \n")
    f.write(" date \t  mean thickness FF2 \t  std thickness FF2 \t  mean thickness RDG2 \t  std thickness RDG2 \t  pvalue thickness (FF2 vs RDG2) \n")
    for i in range(len(mean_delta_d_FF2_dict)):
        date = dates_laser[i]
        f.write(
            str(date)
            ...
            + str(std_thickness_RDG2_dict[date])
            + "\t"
            + str(thickness_pvalue_dict_2[int(date[0:6])])
            + "\n"
        ) 
    ...
    complete_txt_filename_all = path_to_processed_data + "/delta_d_mean_std_and_pvalues.txt"
    f = open(complete_txt_filename_all, "w")
    
    f.write("delta_d - 1 \n")
    f.write(" date \t  mean delta_d FF1 \t  std delta_d FF1 \t  mean delta_d RDG1 \t  std delta_d RDG1 \t  pvalue delta_d (FF1 vs RDG1) \n")
    for i in range(len(mean_delta_d_FF1_dict)):
        date = dates_laser[i]
        f.write(
            str(date)
            ...
            + str(std_delta_d_RDG1_dict[date])
            + "\t"
            + str(delta_d_pvalue_dict_1[int(date[0:6])])
            + "\n"
        )    

    f.write("delta_d - 2 \n")
    f.write(" date \t  mean delta_d FF2 \t  std delta_d FF2 \t  mean delta_d RDG2 \t  std delta_d RDG2 \t  pvalue delta_d (FF2 vs RDG2) \n")
    for i in range(len(mean_delta_d_FF2_dict)):
        date = dates_laser[i]
        f.write(
            str(date)
            ...
            + str(std_delta_d_RDG2_dict[date])
            + "\t"
            + str(delta_d_pvalue_dict_2[int(date[0:6])])
            + "\n"
        ) 
    ...
    complete_txt_filename_all = path_to_processed_data + "/delta_d_star_mean_std_and_pvalues.txt"
    f = open(complete_txt_filename_all, "w")
    
    f.write("delta_d_star - 1 \n")
    f.write(" date \t  mean delta_d_star FF1 \t  std delta_d_star FF1 \t  mean delta_d_star RDG1 \t  std delta_d_star RDG1 \t  pvalue delta_d_star (FF1 vs RDG1) \n")
    for i in range(len(mean_delta_d_FF1_dict)):
        date = dates_laser[i]
        f.write(
            str(date)
            ...
            + str(std_delta_d_star_RDG1_dict[date])
            + "\t"
            + str(delta_d_star_pvalue_dict_1[int(date[0:6])])
            + "\n"
        )    

    f.write("delta_d_star - 2 \n")
    f.write(" date \t  mean delta_d_star FF2 \t  std delta_d_star FF2 \t  mean delta_d_star RDG2 \t  std delta_d_star RDG2 \t  pvalue delta_d_star (FF2 vs RDG2) \n")
    for i in range(len(mean_delta_d_FF2_dict)):
        date = dates_laser[i]
        f.write(
            str(date)
            ...
            + str(std_delta_d_star_RDG2_dict[date])
            + "\t"
            + str(delta_d_star_pvalue_dict_2[int(date[0:6])])
            + "\n"
        ) 
    ...
    complete_txt_filename_all = path_to_processed_data + "/d_min_mean_std_and_pvalues.txt"
    f = open(complete_txt_filename_all, "w")
    
    f.write("d_min - 1 \n")
    f.write(" date \t  mean d_min FF1 \t  std d_min FF1 \t  mean d_min RDG1 \t  std d_min RDG1 \t  pvalue d_min (FF1 vs RDG1) \n")
    for i in range(len(mean_delta_d_FF1_dict)):
        date = dates_laser[i]
        f.write(
            str(date)
            ...
            + str(std_d_min_RDG1_dict[date])
            + "\t"
            + str(d_min_pvalue_dict_1[int(date[0:6])])
            + "\n"
        )    

    f.write("d_min - 2 \n")
    f.write(" date \t  mean d_min FF2 \t  std d_min FF2 \t  mean d_min RDG2 \t  std d_min RDG2 \t  pvalue d_min (FF2 vs RDG2) \n")
    for i in range(len(mean_delta_d_FF2_dict)):
        date = dates_laser[i]
        f.write(
            str(date)
            ...
            + str(std_d_min_RDG2_dict[date])
            + "\t"
            + str(d_min_pvalue_dict_2[int(date[0:6])])
            + "\n"
        ) 
    ...
    complete_txt_filename_all = path_to_processed_data + "/A_mean_std_and_pvalues.txt"
    f = open(complete_txt_filename_all, "w")
    
    f.write("A - 1 \n")
    f.write(" date \t  mean A FF1 \t  std A FF1 \t  mean A RDG1 \t  std A RDG1 \t  pvalue A (FF1 vs RDG1) \n")
    for i in range(len(mean_delta_d_FF1_dict)):
        date = dates_laser[i]
        f.write(
            str(date)
            ...
            + str(std_A_RDG1_dict[date])
            + "\t"
            + str(A_pvalue_dict_1[int(date[0:6])])
            + "\n"
        )    

    f.write("A - 2 \n")
    f.write(" date \t  mean A FF2 \t  std A FF2 \t  mean A RDG2 \t  std A RDG2 \t  pvalue A (FF2 vs RDG2) \n")
    for i in range(len(mean_delta_d_FF2_dict)):
        date = dates_laser[i]
        f.write(
            str(date)
            ...
            + str(std_A_RDG2_dict[date])
            + "\t"
            + str(A_pvalue_dict_2[int(date[0:6])])
            + "\n"
        ) 
...
def plot_recovery_indicators_with_maturation(deltad_threshold, strain_threshold):
    """
    ...
    savefigure.save_as_png(fig_Umax_2, "0_locations_deltad_threshold" + str(deltad_threshold) + "strain_treshold" + str(strain_threshold) + "_Umax_vs_maturation_2")
    ...
    savefigure.save_as_png(fig_strain_2, "0_locations_deltad_threshold" + str(deltad_threshold) + "strain_treshold" + str(strain_threshold) + "_strain_vs_maturation_2")
    ...
    savefigure.save_as_png(fig_delta_d_2, "0_locations_deltad_threshold" + str(deltad_threshold) + "strain_treshold" + str(strain_threshold) + "_delta_d_vs_maturation_2")
    ...
    savefigure.save_as_png(fig_delta_d_star_2, "0_locations_deltad_threshold" + str(deltad_threshold) + "strain_treshold" + str(strain_threshold) + "_delta_d_star_vs_maturation_2")
    ...
    plt.close(fig_A_1)        
    savefigure.save_as_png(fig_A_2, "0_locations_deltad_threshold" + str(deltad_threshold) + "strain_treshold" + str(strain_threshold) + "_A_vs_maturation_2")
    plt.close(fig_A_2)    
    ...
    savefigure.save_as_png(fig_d_min_2, "0_locations_deltad_threshold" + str(deltad_threshold) + "strain_treshold" + str(strain_threshold) + "_d_min_vs_maturation_2")
    plt.close(fig_d_min_2)    

def plot_laser_indicators_vs_texturometer_forces(deltad_threshold, strain_threshold):
    """
    ...
    savefigure.save_as_png(fig_Umax_vs_force80_1, "0_locations_deltad_threshold" + str(deltad_threshold) + "strain_treshold" + str(strain_threshold) + "_Umax_vs_force80_1")
    ...
    savefigure.save_as_png(fig_Umax_vs_force80_2, "0_locations_deltad_threshold" + str(deltad_threshold) + "strain_treshold" + str(strain_threshold) + "_Umax_vs_force80_2")
    ...
    savefigure.save_as_png(fig_Umax_vs_force80, "0_locations_deltad_threshold" + str(deltad_threshold) + "strain_treshold" + str(strain_threshold) + "_Umax_vs_force80_1+2")
    ...
    savefigure.save_as_png(fig_Umax_vs_force20_1, "0_locations_deltad_threshold" + str(deltad_threshold) + "strain_treshold" + str(strain_threshold) + "_Umax_vs_force20_1")
    ...
    savefigure.save_as_png(fig_Umax_vs_force20_2, "0_locations_deltad_threshold" + str(deltad_threshold) + "strain_treshold" + str(strain_threshold) + "_Umax_vs_force20_2")
    ...
    savefigure.save_as_png(fig_Umax_vs_force20, "0_locations_deltad_threshold" + str(deltad_threshold) + "strain_treshold" + str(strain_threshold) + "_Umax_vs_force20_1+2")
...
####################################################    
    ...
    savefigure.save_as_png(fig_strain_vs_force80_1, "0_locations_deltad_threshold" + str(deltad_threshold) + "strain_treshold" + str(strain_threshold) + "_strain_vs_force80_1")
    ...
    savefigure.save_as_png(fig_strain_vs_force80_2, "0_locations_deltad_threshold" + str(deltad_threshold) + "strain_treshold" + str(strain_threshold) + "_strain_vs_force80_2")
    ...
    savefigure.save_as_png(fig_strain_vs_force80, "0_locations_deltad_threshold" + str(deltad_threshold) + "strain_treshold" + str(strain_threshold) + "_strain_vs_force80_1+2")
    ...
    savefigure.save_as_png(fig_strain_vs_force20_1, "0_locations_deltad_threshold" + str(deltad_threshold) + "strain_treshold" + str(strain_threshold) + "_strain_vs_force20_1")
    ...
    savefigure.save_as_png(fig_strain_vs_force20_2, "0_locations_deltad_threshold" + str(deltad_threshold) + "strain_treshold" + str(strain_threshold) + "_strain_vs_force20_2")
    ...
    savefigure.save_as_png(fig_strain_vs_force20, "0_locations_deltad_threshold" + str(deltad_threshold) + "strain_treshold" + str(strain_threshold) + "_strain_vs_force20_1+2")
...
####################################################    
    ...
    savefigure.save_as_png(fig_A_vs_force80_1, "0_locations_deltad_threshold" + str(deltad_threshold) + "strain_treshold" + str(strain_threshold) + "_A_vs_force80_1")
    ...
    savefigure.save_as_png(fig_A_vs_force80_2, "0_locations_deltad_threshold" + str(deltad_threshold) + "strain_treshold" + str(strain_threshold) + "_A_vs_force80_2")
    ...
    savefigure.save_as_png(fig_A_vs_force80, "0_locations_deltad_threshold" + str(deltad_threshold) + "strain_treshold" + str(strain_threshold) + "_A_vs_force80_1+2")
    ...
    savefigure.save_as_png(fig_A_vs_force20_1, "0_locations_deltad_threshold" + str(deltad_threshold) + "strain_treshold" + str(strain_threshold) + "_A_vs_force20_1")
    ...
    savefigure.save_as_png(fig_A_vs_force20_2, "0_locations_deltad_threshold" + str(deltad_threshold) + "strain_treshold" + str(strain_threshold) + "_A_vs_force20_2")
    ...
    savefigure.save_as_png(fig_A_vs_force20, "0_locations_deltad_threshold" + str(deltad_threshold) + "strain_treshold" + str(strain_threshold) + "_A_vs_force20_1+2")
    ...
    savefigure.save_as_png(fig_delta_d_vs_force80_1, "0_locations_deltad_threshold" + str(deltad_threshold) + "strain_treshold" + str(strain_threshold) + "_delta_d_vs_force80_1")
    ...
    savefigure.save_as_png(fig_delta_d_vs_force80_2, "0_locations_deltad_threshold" + str(deltad_threshold) + "strain_treshold" + str(strain_threshold) + "_delta_d_vs_force80_2")
    ...
    savefigure.save_as_png(fig_delta_d_vs_force80, "0_locations_deltad_threshold" + str(deltad_threshold) + "strain_treshold" + str(strain_threshold) + "_delta_d_vs_force80_1+2")
    ...
    savefigure.save_as_png(fig_delta_d_vs_force20_1, "0_locations_deltad_threshold" + str(deltad_threshold) + "strain_treshold" + str(strain_threshold) + "_delta_d_vs_force20_1")
    ...
    savefigure.save_as_png(fig_delta_d_vs_force20_2, "0_locations_deltad_threshold" + str(deltad_threshold) + "strain_treshold" + str(strain_threshold) + "_delta_d_vs_force20_2")
    ...
    savefigure.save_as_png(fig_delta_d_vs_force20, "0_locations_deltad_threshold" + str(deltad_threshold) + "strain_treshold" + str(strain_threshold) + "_delta_d_vs_force20_1+2")
    ...
    savefigure.save_as_png(fig_delta_d_star_vs_force80_1, "0_locations_deltad_threshold" + str(deltad_threshold) + "strain_treshold" + str(strain_threshold) + "_delta_d_star_vs_force80_1")
    ...
    savefigure.save_as_png(fig_delta_d_star_vs_force80_2, "0_locations_deltad_threshold" + str(deltad_threshold) + "strain_treshold" + str(strain_threshold) + "_delta_d_star_vs_force80_2")
    ...
    savefigure.save_as_png(fig_delta_d_star_vs_force80, "0_locations_deltad_threshold" + str(deltad_threshold) + "strain_treshold" + str(strain_threshold) + "_delta_d_star_vs_force80_1+2")
    ...
    savefigure.save_as_png(fig_delta_d_star_vs_force20_1, "0_locations_deltad_threshold" + str(deltad_threshold) + "strain_treshold" + str(strain_threshold) + "_delta_d_star_vs_force20_1")
    ...
    savefigure.save_as_png(fig_delta_d_star_vs_force20_2, "0_locations_deltad_threshold" + str(deltad_threshold) + "strain_treshold" + str(strain_threshold) + "_delta_d_star_vs_force20_2")
    ...
    savefigure.save_as_png(fig_delta_d_star_vs_force20, "0_locations_deltad_threshold" + str(deltad_threshold) + "strain_treshold" + str(strain_threshold) + "_delta_d_star_vs_force20_1+2")
    ...
    savefigure.save_as_png(fig_d_min_vs_force80_1, "0_locations_deltad_threshold" + str(deltad_threshold) + "strain_treshold" + str(strain_threshold) + "_d_min_vs_force80_1")
    ...
    savefigure.save_as_png(fig_d_min_vs_force80_2, "0_locations_deltad_threshold" + str(deltad_threshold) + "strain_treshold" + str(strain_threshold) + "_d_min_vs_force80_2")
    ...
    savefigure.save_as_png(fig_d_min_vs_force80, "0_locations_deltad_threshold" + str(deltad_threshold) + "strain_treshold" + str(strain_threshold) + "_d_min_vs_force80_1+2")
    ...
    savefigure.save_as_png(fig_d_min_vs_force20_1, "0_locations_deltad_threshold" + str(deltad_threshold) + "strain_treshold" + str(strain_threshold) + "_d_min_vs_force20_1")
    ...
    savefigure.save_as_png(fig_d_min_vs_force20_2, "0_locations_deltad_threshold" + str(deltad_threshold) + "strain_treshold" + str(strain_threshold) + "_d_min_vs_force20_2")
    ...
    savefigure.save_as_png(fig_d_min_vs_force20, "0_locations_deltad_threshold" + str(deltad_threshold) + "strain_treshold" + str(strain_threshold) + "_d_min_vs_force20_1+2")
    plt.close(fig_d_min_vs_force20)


def compute_pvalue_between_meatpieces(meatpiece1, meatpiece2, ids_list, date_dict, Umax_dict, def_dict, thickness_dict, delta_d_dict, delta_d_star_dict, d_min_dict, A_dict):
    dates = list(set(date_dict.values()))
    Umax_pvalue_dict = {}
    def_pvalue_dict = {}
    thickness_pvalue_dict = {}
    delta_d_pvalue_dict = {}
    delta_d_star_pvalue_dict = {}
    d_min_pvalue_dict = {}
    A_pvalue_dict = {}
    ...
    for date in dates:
        ...
        p_value_A = stats.ttest_ind(A_meatpiece1, A_meatpiece2, equal_var=False).pvalue
        A_pvalue_dict[date] = p_value_A

        Umax_meatpiece1 = list(Umax_dict_at_date_and_meatpiece1.values())
        Umax_meatpiece2 = list(Umax_dict_at_date_and_meatpiece2.values())
        p_value_Umax = stats.ttest_ind(Umax_meatpiece1, Umax_meatpiece2, equal_var=False).pvalue
        Umax_pvalue_dict[date] = p_value_Umax

        def_meatpiece1 = list(def_dict_at_date_and_meatpiece1.values())
        def_meatpiece2 = list(def_dict_at_date_and_meatpiece2.values())
        p_value_def = stats.ttest_ind(def_meatpiece1, def_meatpiece2, equal_var=False).pvalue
        def_pvalue_dict[date] = p_value_def
        
        thickness_meatpiece1 = list(thickness_dict_at_date_and_meatpiece1.values())
        thickness_meatpiece2 = list(thickness_dict_at_date_and_meatpiece2.values())
        p_value_thickness = stats.ttest_ind(thickness_meatpiece1, thickness_meatpiece2, equal_var=False).pvalue
        thickness_pvalue_dict[date] = p_value_thickness

        delta_d_meatpiece1 = list(delta_d_dict_at_date_and_meatpiece1.values())
        delta_d_meatpiece2 = list(delta_d_dict_at_date_and_meatpiece2.values())
        p_value_delta_d = stats.ttest_ind(delta_d_meatpiece1, delta_d_meatpiece2, equal_var=False).pvalue
        delta_d_pvalue_dict[date] = p_value_delta_d

        delta_d_star_meatpiece1 = list(delta_d_star_dict_at_date_and_meatpiece1.values())
        delta_d_star_meatpiece2 = list(delta_d_star_dict_at_date_and_meatpiece2.values())
        p_value_delta_d_star = stats.ttest_ind(delta_d_star_meatpiece1, delta_d_star_meatpiece2, equal_var=False).pvalue
        delta_d_star_pvalue_dict[date] = p_value_delta_d_star

        d_min_meatpiece1 = list(d_min_dict_at_date_and_meatpiece1.values())
